...
Los "ai-scripts" son una combinación de scripts para bash y/o python que, o he ido creado para paliar necesidades que han ido surgiendo en el dia a dia de trabajar con la inteligencia artificial en Debian, o he ido descargando de internet (externos) porque me han parecido útiles.
...
Para instalar los ai-scripts en la ubicación aconsejada sigue las instrucciones de este artículo: http://hacks4geeks.com/ia-scripts
